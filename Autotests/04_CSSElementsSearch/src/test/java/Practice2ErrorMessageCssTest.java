...
public class Practice2ErrorMessageCssTest {
    private static WebDriver driver;

    private final By emailLocator = By.cssSelector(".form-input.input-data");
    private final By passwordLocator = By.cssSelector(".form-input.password");
    private final By buttonLocator = By.cssSelector(".form-submit");
